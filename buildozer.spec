...
source.include_exts = py,png,jpg,kv,atlas,wav,ttf,json,ogg,mp3
...
source.exclude_dirs = tests, bin, venv, .buildozer, node_modules
...
requirements = python3,pygame,certifi
